...
class SimCLR(object):
    ...
    def __init__(self, dataset, config):
        ...
        self.nt_xent_criterion = NTXentLoss_try(self.device, config['batch_size'], **config['loss']) # batch_size: 256, # temperature: 0.5, use_cosine_similarity: True
    ...
    def _step(self, model, xis, xjs, n_iter):
        ...
        # get the representations and the projections (latent vectors)
