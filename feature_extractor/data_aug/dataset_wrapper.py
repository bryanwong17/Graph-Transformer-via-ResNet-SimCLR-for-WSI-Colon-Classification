...
class Dataset():
    ...
    def __getitem__(self, idx):
        ...
        # print(temp_path)
        # print("before img")
        img = Image.open("../../dataset/tiles/colon/total/" + temp_path)
        # print("after img")
...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = Dataset(csv_file='train_path_patches.csv', transform=SimCLRDataTransform(data_augment))
    ...
    def get_train_validation_data_loaders(self, train_dataset):
        ...
        split = int(np.floor(self.valid_size * num_train)) # valid_size = 0.1
        train_idx, valid_idx = indices[split:], indices[:split] # take 
